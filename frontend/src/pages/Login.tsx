...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      {/* Container simulating mobile view dimension constraints for desktop */}
      <div className="w-full max-w-md bg-surface p-8 sm:p-10 rounded-[2.5rem] shadow-sm border border-border/60">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 text-primary mb-6">
            <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center">
              <span className="text-white font-bold text-xl block transform -translate-y-[1px]">S</span>
            </div>
          </div>
          <h1 className="text-3xl font-extrabold text-textMain mb-2 tracking-tight">SmartSpend AI</h1>
          <p className="text-textMuted text-base">Sign in to track your expenses</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center ml-1">
              <label className="text-sm font-semibold text-textMain">Password</label>
              <a href="#" className="text-sm font-semibold text-primary hover:text-primary/80 transition-colors">Forgot?</a>
            </div>
            <div className="relative">
        ...
        <p className="mt-10 text-center text-sm font-medium text-textMuted">
          Don't have an account? <Link to="/signup" className="text-primary hover:text-primary/80 transition-colors">Create one</Link>
        </p>
      </div>
    </div>
  );
